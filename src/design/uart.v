...
module baud (
	...
	input	[data_len - 1:0]xmit_dataH,	//data to be sent, This data is sample when xmith high
	...
	output	[data_len - 1:0]rec_dataH,		//de-serialized recieved from the remote
	...
	*/
	...
	u_rec	rec(
		.sys_rst_l(sys_rst_l), .xmitH(xmitH), .uart_REC_dataH(uart_REC_dataH),		//Main_inputs
